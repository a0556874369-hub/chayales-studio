...
export const works: Work[] = [
  {
    ...
    caseStudy: {
      ...
      whyItWorks:
        "המערכת עושה סדר בתהליך שמטבעו יכול להיות עמוס: המחפש מבין מהר איך למצוא נכס רלוונטי, והמפרסם מקבל דרך ברורה להעלות ולנהל מודעה. פאנל האדמין המותאם מאפשר לנהל את כל האתר בקלות, גם בלי רקע טכני. זה לא רק אתר יפה - זו פלטפורמה שנבנתה סביב שימוש אמיתי.",
  ...
  },
  {
    ...
    caseStudy: {
      kind: "website",
      category: "שיווק וקוד מותאם",
      intro:
        "iCanSit - מותג אורתופדי שפועל בישראל ובארה״ב, עם נוכחות דיגיטלית שמחברת בין כאב אמיתי, אמון מקצועי וחוויית קנייה ברורה.",
      roleLine:
        "במסגרת העבודה שלי עם iCanSit אני מובילה את הנראות, הקופי, הקריאייטיב, הקוד והדיגיטל של המותג.",
      challengeTitle: "האתגר",
      challenge:
  ...
  },
  {
    ...
    caseStudy: {
      ...
      middleText:
        "סדרת מודעות עונתית באותה שפה רכה ומזוהה - חדרים חמימים ומזמינים בחורף, ונופים קיציים משגעים בקיץ.",
      whyItWorks:
    ...
    gridImage: {
      src: "/portfolio/olam-hatinok/final-main.png",
      alt: "עולם התינוק - המודעה העדכנית",
    },
    modalImages: [
      {
  ...
  },
  {
    ...
    caseStudy: {
      ...
      middleTitle: "מה עיצבתי",
      middleText: "סדרת מודעות יוקרתיות בגווני זהב, אלגנטיות וזכירות.",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      category: "עיצוב וקריאייטיב",
      intro:
        "דנטל - מיתוג מחודש ושפה מסודרת לחנות הלבשה משפחתית עם 25 שנות ותק.",
      challengeTitle: "המטרה",
      challenge: "להפוך מגוון רחב לכל המשפחה לתחושה רגועה ונגישה, לא עמוסה.",
      middleTitle: "מה עיצבתי",
      bullets: [
        "עיצוב מחדש של הלוגו והמיתוג: סטייל, עדכניות ואצילות",
