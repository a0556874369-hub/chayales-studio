...
const HERO_ADVANTAGE: Advantage = {
  ...
  title: "בלי \"אי אפשר\"",
  description:
    "רוצים משהו מיוחד באתר? בונים אותו. בלי תבנית שתוקעת אתכם, בלי פשרות.",
};

const SUPPORTING_ADVANTAGES: Advantage[] = [
  {
    num: "02",
    title: "נטען מהר, לא מאבד אף אחד",
    description: "אתר כבד מבריח מבקרים בשניות. קוד נקי נטען מיד - והם נשארים.",
  },
  {
    num: "03",
  ...
  {
    num: "04",
    title: "שימצאו אתכם בגוגל",
    description: "מבנה נקי שגוגל אוהב - כדי שכשמחפשים את מה שאתם מוכרים, מגיעים אליכם.",
  },
  {
    num: "05",
    title: "תנועה שמובילה לפעולה",
    description: "כל גלילה ומעבר מובילים את העין למה שחשוב - עד שהם פונים אליכם.",
  },
];
