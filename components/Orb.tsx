...
export default function Orb() {
  ...
  // sec8: מתחיל בערך של סוף sec4 (הסקשנים צמודים - sec8Start ≈ sec4End,
  // ערכים שונים שם = טלפורט) וגולש מימין לשמאל לאורך גלילת האודות.
  ...
  const rotate = useTransform(scrollY, points, [
    0, 0, 0.5, 0, 0, -0.3, -0.5, -0.3, 0, 0.3, 0.3, 1.4, 1.6, 1.8,
  ]);
